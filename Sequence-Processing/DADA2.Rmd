...
Use the ASVs_counts.txt tables for taxonomy assignment in BLAST+. After assigning taxonomy for each batch, these files must be further filtered prior to diet analyses. See Filtering-and-QC folder for next steps.
