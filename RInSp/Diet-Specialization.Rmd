...
Calculate Proportional Similarity index value for each coyote with eight or more scats.
...
# Range of PSi value in the population
hist(temp$PSi, xlim = c(0, 1))
...
Overlay PSi values onto stacked bar plot showing diet variation among frequently sample coyotes. NOTE - prior to running this code the stacked bar plot (p.ind_stackedbar) from the Diet-Plots.Rmd file must be generated.
...
# Align plots
p.aligned <- align_plots(p.diet, p.PSi, align = c("hv"), axis = 'rlbt')
